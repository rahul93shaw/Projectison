...
public class DemoSixthScreen extends Activity {
Button back,btn6;
...
EditText quan;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        quan = (EditText) findViewById(R.id.text7);
			...
			public void onClick(View arg0) {
				if(quan.getText().toString().equals(str1)||quan.getText().toString().equals(str2)||quan.getText().toString().equals(str3))
				{
				 Intent nextScreen = new Intent(getApplicationContext(), confirmation.class);
	                ...
	                nextScreen.putExtra("name","SAMSUNG GALAXY S4");
	                nextScreen.putExtra("price","18999");
