...
public class DemoNinthScreen extends Activity {
Button back,btn9;
...
EditText quan;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        quan = (EditText) findViewById(R.id.text3);
			...
			public void onClick(View arg0) {
				if(quan.getText().toString().equals(str1)||quan.getText().toString().equals(str2)||quan.getText().toString().equals(str3))
				{
				 Intent nextScreen = new Intent(getApplicationContext(), confirmation.class);
	                ...
	                nextScreen.putExtra("name","SONY F5 CINEALTA");
	                nextScreen.putExtra("price","69999");
