...
public class DemoFourthScreen extends Activity {
Button back,btn4;
...
EditText quan;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        quan = (EditText) findViewById(R.id.text5);
			...
			public void onClick(View arg0) {
				if(quan.getText().toString().equals(str1)||quan.getText().toString().equals(str2)||quan.getText().toString().equals(str3))
				{
				 Intent nextScreen = new Intent(getApplicationContext(), confirmation.class);
	                ...
	                nextScreen.putExtra("name","HTC DESIRE Z310");
	                nextScreen.putExtra("price","10999");
