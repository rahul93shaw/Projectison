...
public class DemoEightScreen extends Activity{
Button back,btn8;
...
EditText quan;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        quan = (EditText) findViewById(R.id.text4);
			...
			public void onClick(View arg0) {
				if(quan.getText().toString().equals(str1)||quan.getText().toString().equals(str2)||quan.getText().toString().equals(str3))
				{
				 Intent nextScreen = new Intent(getApplicationContext(), confirmation.class);
	                ...
	                nextScreen.putExtra("name","CANON SX700HS");
	                nextScreen.putExtra("price","20999");
