...
public class DemoSeventhScreen extends Activity {
Button back,btn7;
...
EditText quan;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nikon);
 
        Intent i = getIntent();
        quan = (EditText) findViewById(R.id.text2);
			...
			public void onClick(View arg0) {
				if(quan.getText().toString().equals(str1)||quan.getText().toString().equals(str2)||quan.getText().toString().equals(str3))
				{
				 Intent nextScreen = new Intent(getApplicationContext(), confirmation.class);
	                ...
	                nextScreen.putExtra("name","NIKON D3200 DSLR");
	                nextScreen.putExtra("price","25999");
